    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "clusterid",
                    models.BigIntegerField(
                        blank=True, null=True, verbose_name="Cluster Id"
                    ),
                ),
                (
                    "procid",
                    models.IntegerField(blank=True, null=True, verbose_name="Proc Id"),
                ),
                (
                    "global_job_id",
                    models.CharField(
                ...
                (
                    "args",
                    models.CharField(
                        blank=True, max_length=2000, null=True, verbose_name="Args"
                    ),
                ),
                (
                    "submit_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Submit Time"
                    ),
                ),
                (
                    "start_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "execution_ccd_images",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution CCD Images"
                    ),
                ),
                (
                    "execution_bsp_jpl",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution BSP JPL"
                    ),
                ),
                (
                    "execution_catalog",
                ...
                (
                    "execution_astrometry",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Astrometry"
                    ),
                ),
                (
                    "count_objects",
                ...
                (
                    "error_traceback",
                    models.TextField(
                        blank=True, null=True, verbose_name="Error Traceback"
                    ),
                ),
                (
                    "catalog",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=None,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="condor_jobs",
                to="praia.Run",
                verbose_name="Astrometry Run",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="astrometryoutput",
            index=models.Index(
                fields=["ccd_image"], name="praia_astro_ccd_ima_7a04a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="astrometryoutput",
            index=models.Index(
                fields=["file_type"], name="praia_astro_file_ty_b06b01_idx"
            ),
        ),
