...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("skybot", "0006_auto_20201103_1706"),
        ("skybot", "0007_alter_position_id"),
        ("skybot", "0008_auto_20230214_1811"),
        ("skybot", "0009_alter_position_unique_together"),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="position",
            index=models.Index(
                fields=["dynclass"], name="skybot_posi_dynclas_9f5817_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="position",
        ...
        migrations.AddIndex(
            model_name="position",
            index=models.Index(
                fields=["skybot_job"], name="skybot_posi_skybot__aea079_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="position",
