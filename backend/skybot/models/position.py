...
class Position(models.Model):
    ...
    created = models.DateTimeField(
        verbose_name="Created", auto_now_add=True, null=True, blank=True
    )

    # Des Skybot Job, Não é uma foreign key por problemas de importação dos models.
    skybot_job = models.IntegerField(
        verbose_name="Skybot Job", null=False, blank=False, default=0
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["skybot_job"]),
        ]
