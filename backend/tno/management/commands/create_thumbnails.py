...
from tno.tasks import (
    create_thumbnail_map_task,
    thumbnail_maps_log_error,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        to_run = upcoming_events_to_create_maps(start, end, limit, magnitude_limit=21)
        ...
        job = group(header)
        job.link_error(thumbnail_maps_log_error.s())
