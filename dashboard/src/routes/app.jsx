...
const appRoutes = [
    { path: "/dashboard", name: "Dashboard", icon: "fa fa-home", component: Dashboard },
    { path: "/getpointings", name: "Get Pointings", icon: "pe-7s-target", component: GetPointings },
    { path: "/solarsystems", name: "Solar Systems", icon: "pe-7s-sun", component: SolarSystems },
    { path: "/skybot", name: "SkyBoT", icon: "pe-7s-science", component: SkyBot },
    { path: "/filterobject", name: "Filter Objects", icon: "pe-7s-filter", component: FilterObject },
    { path: "/exposuredownload", name: "Exposure Download", icon: "pe-7s-download", component: ExposureDownload },
