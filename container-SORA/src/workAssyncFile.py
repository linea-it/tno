...
class WorkAssyncFile:
    def __init__(self,input_path=None, output_path=None):
        self.__input_path = input_path if input_path is not None else os.getenv('INPUT_PATH', '~/input')
        self.__output_path = output_path if output_path is not None else os.getenv('OUTPUT_PATH', '~/output')
    ...
    def __nextFile(self):
        ...
        files = sorted(files, key=lambda n: os.path.getmtime(os.path.join(self.__input_path,n)))
