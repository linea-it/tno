...
class CcdDao(DBBase):
    ...
    def ccds_by_exposure(self, exposure_id):
        ...
        stm = (
            select(tbl.c)
            .where(and_(tbl.c.exposure_id == int(exposure_id)))
            .order_by(tbl.c.ccdnum)
        )
    ...
    def count_ccds_by_period(self, start, end):
        ...
        stm = (
            ...
            .select_from(dc_tbl.join(de_tbl, dc_tbl.c.exposure_id == de_tbl.c.id))
    ...
    def count_by_period(self, start, end, dynclass=None, name=None):
        ...
        stm = (
            ...
            .select_from(
                ...
                .join(dd, dc.c.id == dd.c.ccd_id, isouter=True)
            )
