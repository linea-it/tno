    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('results', models.CharField(blank=True, default=None, help_text='Filepath to the results.csv. this file contains the results of the job.', max_length=2048, null=True, verbose_name='Results')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(help_text='Represents a specific position in the Skybot result.', on_delete=django.db.models.deletion.CASCADE, to='skybot.Position', verbose_name='Position')),
            ],
        ),
        migrations.AddIndex(
            model_name='exposure',
        ...
        migrations.AddField(
            model_name='ccd',
            name='exposure',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='des.Exposure', verbose_name='Exposure'),
        ),
