    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_summary_dynclass', to='des.SkybotJob', verbose_name='Skybot Job')),
            ],
        ),
        migrations.AddIndex(
            model_name='summarydynclass',
            index=models.Index(fields=['dynclass'], name='des_summary_dynclas_b5a895_idx'),
        ),
    ]
