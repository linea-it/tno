    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ra_star_deg', models.FloatField(blank=True, help_text='Right ascension of star in degrees', null=True, verbose_name='RA Star (deg)')),
                ('dec_star_deg', models.FloatField(blank=True, help_text='Declination of star in degrees', null=True, verbose_name='Dec Star (deg)')),
                ('ra_target_deg', models.FloatField(blank=True, help_text='Right ascension of target in degrees', null=True, verbose_name='RA Target (deg)')),
                ('dec_target_deg', models.FloatField(blank=True, help_text='Declination of target in degrees', null=True, verbose_name='Dec Target (deg)')),
                ('asteroid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='occultation', to='tno.Asteroid', verbose_name='Asteroid')),
            ],
        ),
    ]
