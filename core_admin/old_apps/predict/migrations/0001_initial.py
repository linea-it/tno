    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        blank=True, null=True, verbose_name="Catalog Rows"
                    ),
                ),
                (
                    "execution_time",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Start Ephemeris"
                    ),
                ),
                (
                    "finish_ephemeris",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Finish Ephemeris"
                    ),
                ),
                (
                    "execution_ephemeris",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Ephemeris"
                    ),
                ),
                (
                    "start_catalog",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Start Catalog"
                    ),
                ),
                (
                    "finish_catalog",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Finish Catalog"
                    ),
                ),
                (
                    "execution_catalog",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Catalog"
                    ),
                ),
                (
                    "start_search_candidate",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Start Search Candidate"
                    ),
                ),
                (
                    "finish_search_candidate",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Finish Search Candidate"
                    ),
                ),
                (
                    "execution_search_candidate",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Search Candidate"
                    ),
                ),
                (
                    "start_maps",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Start Maps"
                    ),
                ),
                (
                    "finish_maps",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Finish Maps"
                    ),
                ),
                (
                    "execution_maps",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Maps"
                    ),
                ),
                (
                    "relative_path",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("dates_file", "Dates"),
                            ("bsp_planetary", "Planetary Ephemeris"),
                            ("bsp_asteroid", "Asteroid JPL Ephemeris"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "stars_parameters_of_occultation",
                                "Start Parameters of Occultation",
                            ),
                            (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "execution_dates",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Dates"
                    ),
                ),
                (
                    "execution_ephemeris",
                ...
                (
                    "execution_register",
                    models.DurationField(
                        blank=True, null=True, verbose_name="Execution Register"
                    ),
                ),
                (
                    "average_time",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="predict.BspPlanetary",
                        verbose_name="BSP Planetary",
                    ),
                ),
                (
                    "catalog",
                ...
                (
                    ...
                    models.ForeignKey(
                        default=None,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="predict_input_list",
                        to="tno.CustomList",
                ...
                (
                    ...
                    models.ForeignKey(
                        default=None,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="predict_input_orbit_run",
                        to="orbit.OrbitRun",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="predict.PredictRun",
                verbose_name="Predict Run",
            ),
        ),
        migrations.AddField(
