...
export const getSkybotRunById = ({ id }) => api.get(`/des/skybot_job/${id}`).then((res) => res.data)
...
export const getNightsSuccessOrFail = (id) => api.get(`/des/skybot_job/${id}/nites_success_or_fail/`).then((res) => res.data)

export const getSkybotProgress = (id) => api.get(`/des/skybot_job/${id}/heartbeat/`).then((res) => res.data)
...
export const getSkybotResultById = ({ id, pageSize, page, ordering }) => {
  ...
  return api.get(`/des/skybot_job_result/`, { params }).then((res) => res.data)
}

export const getSkybotTimeProfile = (id) => api.get(`/des/skybot_job/${id}/time_profile/`).then((res) => res.data)

export const getSkybotJobResultById = (id) => api.get(`/des/skybot_job_result/${id}/`).then((res) => res.data)
...
export const getExposureById = (id) => api.get(`/des/exposure/${id}`).then((res) => res.data)

export const cancelSkybotJobById = (id) => api.post(`/des/skybot_job/${id}/cancel_job/`).then((res) => res.data)

export const getDynclassAsteroidsById = (id) => api.get(`/des/skybot_job_result/${id}/dynclass_asteroids/`).then((res) => res.data)

export const getDynclassAsteroids = (id) => api.get(`/des/summary_dynclass?job=${id}`).then((res) => res.data.results)

export const getCcdsWithAsteroidsById = (id) => api.get(`/des/skybot_job_result/${id}/ccds_with_asteroids/`).then((res) => res.data)

export const getSkybotCalcExecutionTime = (exposures) =>
  api.get(`/des/skybot_job/calc_execution_time?to_execute=${exposures}`).then((res) => res.data.estimated_time)
...
export const SubmitSkybotJobsBalanced = () => {
  return api.post('/des/skybot_job/submit_job_balanced_periods/')
}