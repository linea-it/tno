...
function OccultationFilter({
  ...
  const filterClick = () => {
    ...
    if ((validLatitude && validLongitude) || !geoFilter) filter()
  }
                ...
                <Grid container spacing={2} alignItems='stretch'>
                  ...
                  <Grid item xs={12} sm={6} md={2}>
                    <FormControl fullWidth>
                      ...
                      <Slider value={magnitude} step={1} min={4} max={23} valueLabelDisplay='auto' onChange={handleChangeMagnitudeValue} />
                    </FormControl>
                  </Grid>
                  <Grid item xs={12}>
                    <Grid item xs={12}>
                      <label>Geo Filter</label>
                      <Checkbox value={geoFilter} onChange={handleChangeGeoFilter} />
                    </Grid>
                    <Grid item xs={12}>
                      <Card>
                        <CardContent>
                          <Grid container spacing={2} alignItems='stretch'>
                            ...
                            <Grid item xs={12}>
                              <i>
                                This is an experimental feature and may take some time to process. To prevent timeouts, we recommend using
                                date and magnitude ranges that restrict the supplied list to a maximum of 200 objects. You can find this
                                information in 'Total Occultation Predictions' after performing a search.
                              </i>
                            </Grid>
                            {erroLocation && (
                              <Grid item xs={12}>
                                <i className={classes.warningMsg}>
                                  A response was not returned within the allotted time. Try refining the filters fields.
                                </i>
                              </Grid>
                            )}
                          </Grid>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Box className={classes.btnFilter}>
                      <Button disabled={loadingLocation} onClick={filterClick} variant='contained' className='buttonClear' color='primary'>
                        ...
                        {loadingLocation && <CircularProgress size={25} color='primary' />}
                        {!loadingLocation && (
                          <Typography variant='button' sx={{ margin: '0 5px' }}>
                            Search
                          </Typography>
