...
var Terminator = L.Polygon.extend({
  options: {
    ...
    resolution: 5,
    longitudeRange: 720,
    daytime: false // Default to night shading
  },
  ...
  initialize: function (options) {
    ...
    var latLng = this._compute(this.options.time, this.options.daytime)
    this.setLatLngs(latLng)
  },

  setTime: function (date) {
    this.options.time = date
    var latLng = this._compute(date, this.options.daytime)
    this.setLatLngs(latLng)
  },
  ...
  _eclipticObliquity: function (julianDay) {
    ...
    var T = n / 36525
    var epsilon =
      23.43929111 - T * (46.836769 / 3600 - T * (0.0001831 / 3600 + T * (0.0020034 / 3600 - T * (0.576e-6 / 3600 - (T * 4.34e-8) / 3600))))
    return epsilon
  },
  ...
  _compute: function (time, daytime) {
