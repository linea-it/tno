  ...
  return (
    <footer className={classes.footer}>
          ...
          <Grid md={6} className={classes.partnerSection}>
            ...
            <Box className={classes.contactSection}>
              <Typography variant="body1" className={classes.contactInfo}>
                e-mail: <Link href="mailto:secretaria@linea.org.br" sx={{
                  textDecoration: 'none', color: '#000', mr: '16px',
                  '&:hover': { textDecoration: 'underline' },
                }} className={classes.link}>secretaria@linea.org.br</Link>
              </Typography>
              <Typography variant="body1" className={classes.contactInfo}>
                tel: <Link href="tel:+5521969379224" sx={{
                  fontWeight: 'bold', textDecoration: 'none', color: '#000',
                  '&:hover': { textDecoration: 'underline' },
                }} className={classes.link}>+55 21 96937 9224</Link>
              </Typography>
            </Box>

            <Box className={classes.socialIcons}>
              <IconButton href="https://www.linkedin.com/company/linea-astronomia" target="_blank" sx={{ color: '#283664' }} className={`${classes.socialIcon} ${classes.linkedinHover}`}>
                <LinkedInIcon />
              </IconButton>
              <IconButton href="https://x.com/linea_org" target="_blank" className={`${classes.socialIcon}`}>
                <XIcon />
              </IconButton>
              <IconButton href="https://www.instagram.com/linea_org/" target="_blank" sx={{ color: '#283664' }} className={`${classes.socialIcon} ${classes.instagramHover}`}>
                <InstagramIcon />
              </IconButton>
              <IconButton href="https://www.youtube.com/@linea_org" target="_blank" sx={{ color: '#283664' }} className={`${classes.socialIcon} ${classes.youtubeHover}`}>
                <YouTubeIcon />
              </IconButton>
              <IconButton href="https://www.facebook.com/linea.org" target="_blank" sx={{ color: '#283664' }} className={`${classes.socialIcon} ${classes.facebookHover}`}>
                <FacebookIcon />
              </IconButton>
            </Box>
          </Grid>
      ...
      <Typography variant="body2" className={classes.bottomText} sx={{ marginTop: '40px' }}>
        LIneA - 2024 - All rights reserved | <Link href="https://www.linea.org.br/politica-de-privacidade" target="_blank" sx={{
          color: '#000', textDecoration: 'none',
          '&:hover': { textDecoration: 'underline' },
        }} className={classes.link}>Privacy Policy</Link>
      </Typography>
    </footer>
  )
}
