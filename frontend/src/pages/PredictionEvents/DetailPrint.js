...
function PredictionEventDetail() {
  ...
  return (
      <Container>
        <Typography align='center'>Occultation by 2015 GM83</Typography>
        <Typography align='center'>Aug 14, 2024</Typography>
        <Divider/>
        <Card>
            <Typography background='blue' align='center'>Occultation Prediction Circumstances</Typography>
        </Card>
      </Container>
  )
}
