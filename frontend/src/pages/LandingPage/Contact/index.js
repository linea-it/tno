          ...
          <Grid className={classes.grid}>
            ...
            <p>
              <span>
                ...
                to be redirected to the tutorials page. Or if you still have questions, suggestions or complaints, you can contact us using
                the form below.
              </span>
            </p>
            <br />
            <form ref={formRef} autoComplete='off' onSubmit={handleSubmit}>
              <div className={classes.textFields}>
                <TextField required id='name' type='text' variant='outlined' label='Name' placeholder='Name' fullWidth size='small' />
              </div>

              <div className={classes.textFields}>
                <TextField required id='from' type='email' variant='outlined' label='Email' placeholder='Email' fullWidth size='small' />
              </div>
