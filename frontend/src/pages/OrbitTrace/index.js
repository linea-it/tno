...
function OrbitTrace() {
  ...
  const tableColumns = [
    ...
    },
    {
      ...
      headerTooltip: 'Execution time',
      align: 'center',
      customElement: (row) => (moment.utc(row.avg_exec_time_asteroid * 1000).format("HH:mm:ss.SSS"))
    },
    {
      ...
      headerTooltip: 'Execution time',
      align: 'center',
      customElement: (row) => (moment.utc(row.avg_exec_time_ccd * 1000).format("HH:mm:ss.SSS"))
    },
    {
