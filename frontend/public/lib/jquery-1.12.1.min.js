...
!(function (a, b) {
  ...
  n.fn.extend({
    addClass(a) {
      ...
      if (typeof a === 'string' && a) {
        ...
        while ((c = this[i++]))
          if (
            ((e = Bb(c)), (d = c.nodeType === 1 && ` ${e} `.replace(Ab, ' ')))
          ) {
            g = 0;
    ...
    hasClass(a) {
      ...
      b = ` ${a} `;
      while ((c = this[d++]))
        if (c.nodeType === 1 && ` ${Bb(c)} `.replace(Ab, ' ').indexOf(b) > -1)
          return !0;
      return !1;
    },
  }),
  ...
  function cc(a, b, c, d) {
    ...
    if (n.isArray(b))
      n.each(b, function (b, e) {
        c || $b.test(a)
          ? d(a, e)
          : cc(`${a}[${typeof e === 'object' && e != null ? b : ''}]`, e, c, d);
      });
  ...
  a.attachEvent &&
    a.attachEvent('onunload', function () {
      for (const a in ec) ec[a](void 0, !0);
    }),
